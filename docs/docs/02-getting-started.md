...
| Variable                             | Required | Description                                                                                                   |
| ------------------------------------ | -------- | ------------------------------------------------------------------------------------------------------------- |
| `ENABLE_DYNAMIC_CLIENT_REGISTRATION` | ❌       | Allow clients to self-register via `/register` (RFC 7591). Default `false`. When `false`, `/register` returns `403`, the metadata omits the registration endpoint, and already-registered clients keep working |
